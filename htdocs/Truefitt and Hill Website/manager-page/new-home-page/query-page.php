...
<div id="side-nav" class="sidenav">
  ...
  <div class="container text-center">
    <h1 class="display-2 mb-4">Query</h1>
  </div>
        ...
        <div class="section-content">
            <div class="title-wrap" data-aos="fade-up">
                <div class="col-md-12 text-center">
                    <h2 class="mb-2" id="login-text"><b>Home</b></h2>
                    <p id="login-text2">To search specific data, please use the query form</p><br>
                    <button class="collapsible" id='query'>Query</button>
                    <div class="collapsible-content">
                    <div class="contact1">
                        <div class="container-contact1">
                            <form class="contact1-form validate-form" id="contact-form" name="frmContact" method="post" action="query-page.php">
                                <div class="wrap-input1 validate-input" data-validate = "">
                                    <input class="input1" type="text" name="txtName" id='txtName' placeholder="Customer Name">
                                </div>
                
                                <div class="wrap-input1 validate-input" data-validate = "">
                                    <input class="input1" type="text" name="txtTime" id='txtTime' placeholder="Preferred Timing">
                                </div>
                
                                <div class="wrap-input1 validate-input" data-validate = "">
                                    <input class="input1" type="text" name="txtBarber" id='txtBarber' placeholder="Preferred Barber">
                                </div>

                                <div class="wrap-input1 validate-input" data-validate = "">
                                    <input class="input1" type="text" name="txtStyle" id='txtStyle' placeholder="Preferred Style">
                                </div>

                                <div class="wrap-input1 validate-input" data-validate = "">
                                    <input class="input1" type="text" name="txtProd" id='txtProd' placeholder="Preferred Product">
                                </div>

                                <div class="wrap-input1 validate-input" data-validate = "">
                                    <input class="input1" type="text" name="txtRecurr" id='txtRecurr' placeholder="Recurrence">
                                </div>

                                <div class="container-contact1-form-btn">
                                    <input type="submit"  id='submit' name='submit' value='Query' class="contact1-form-btn">
                                </div>
                            </form>
                        </div>
                    </div>
    ...
    <div class="container">
        <div class="section-content pt-0 text-center">
            <div id="full_table" class="table-wrapper">
                ...
                <td><?php echo $data['Preferred_Time']??''; ?></td>
                <td><?php echo $data['Preferred_Barber']??''; ?></td>
                <td><?php echo $data['Preferred_Style']??''; ?></td>
                <td><?php echo $data['Preferred_Product']??''; ?></td>
                <td><?php echo $data['Recurrance']??''; ?></td>
                </tr>
                <?php
                $sn++;}}else{ ?>
                <tr>
        ...
        <div class="section-content pt-0 text-center">
        <button type="button" class="btn btn-outline-primary2 btn-lg" id='show_button' onclick="location.href = 'new-home-page.php';">Show All</button>
        </div>
    </div>
        ...
        <div class="section-content" data-aos="fade-up">
            <div class="row">
                <div class="col-md-12 text-center">
                    ...
                    <p>Download current table in an excel file</p>
