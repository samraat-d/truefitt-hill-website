...
<div id="side-nav" class="sidenav">
  ...
  <div class="container text-center">
    <h1 class="display-2 mb-4">Annual</h1>
  </div>
        ...
        <div class="section-content">
            <div class="title-wrap" data-aos="fade-up">
                <div class="col-md-12 text-center">
                    <h2 class="mb-2" id="login-text"><b>Annual Membership Appointments</b></h2>
                    <p id="login-text2"></p>Remaining annual membership appointments scheduled<br>
                    </div>
                </div>
            </div>
            <!-- /.row -->
